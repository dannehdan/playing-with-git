...
# following words from tweets: "sucks", "bad", "hate", "foolish", and the most 
# popular: "danger to society". Replace each negative word or phrase them with the 
# word "CENSORED". Some test tweets have been provided for you.
...
test_tweets.each do |tweet|
  banned_phrases.each do |censor|
    tweet.gsub!(censor, "CENSORED")
  end
  puts tweet
end